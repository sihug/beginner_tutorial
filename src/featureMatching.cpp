...
public:
    ...
    : it_(nh_), lowThreshold(50), ratio(3), kernel_size(3)
  {
    ...
    image_sub_ = it_.subscribe("/cam0/image_raw", 1, &featureMatching::sensorToCvImage, this);
    cvToSensorImage();
  ...
  void sensorToCvImage(const sensor_msgs::ImageConstPtr& msg)
  {
  ...
  void cvToSensorImage()
  {
	  cv_bridge::CvImagePtr cv_ptr = cv_ptr_tmp;
